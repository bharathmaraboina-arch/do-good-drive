...
const INITIAL_INTERACTIVE_POSTS: InteractivePost[] = [
  ...
  {
    id: 'post-sponsor-pro',
    authorProfileId: 'dogooddrive-pro',
    authorRole: 'corporate',
    authorName: 'Do Good Drive Enterprise',
    authorAvatarUrl: '',
    authorTagline: 'Promoted • ImpactOS Management & Kiosk Solutions',
    type: 'POST',
    cause: 'Community Innovation',
    content: '🚀 Attention non-profit coordinators and corporate CSR leaders: Are you still tracking volunteer attendance with paper clipboards and manual spreadsheets?\n\nWith ImpactOS Pro, automate your volunteer drives in seconds:\n• 📱 Dynamic QR Kiosk Attendance with instant GPS verification\n• 📊 1-Click Board & IRS Form 990 audit-ready reports\n• ⚡ Automated accredited certificates dispatched with custom branding\n\nSave 12+ administrative hours every single week. Start your 14-day free trial today.',
    reactions: { LIKE: 62, CELEBRATE: 44, SUPPORT: 37, INSIGHTFUL: 29 },
    comments: [
      {
        id: 'c-sponsor-1',
        postId: 'post-sponsor-pro',
        authorProfileId: 'ngo-1',
        authorRole: 'ngo',
        authorName: 'GreenCanopy Initiative',
        content: 'Switching to the QR attendance kiosk saved our field botanists hours of roll call paperwork on every planting shift!',
